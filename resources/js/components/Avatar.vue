...
export default {
    ...
    methods: {
        ...
        {
            /**
             * Store the image as 'avatar' in FORM DATA to be passed to POST url
             * avatar: file.file
             */
             ...
             * This route will call ProfileController upload() function
             */
            Axios.post('upload',    // URL: <------------------- Change this URL
            formData,               // Data to be passed
            {                       // Options
                headers: {
